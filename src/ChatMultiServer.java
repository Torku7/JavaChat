...
public class ChatMultiServer {
            ...
            try {
                ...
                while (_DataInputStream != null){
                    ...
                    if(msg.replaceAll(name + " >>> ","").startsWith("@")){
                        if(msg.replaceAll(name+" >>> ","").equals("@접속자")){
    ...
    public static String IsShowUserList(String name){
    ...
    public static void IsSendToMsg(String fromName, String toName, String msg){
        try{
